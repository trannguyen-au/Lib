  ...
  var currentDisplayOffset = 0;
    ...
    $("#"+cId).height(controlHeight+15);
	  ...
	  if(options.pagingTag!="") {
		...
		if(maxPageIndex>0) {
		  // add left and right
      if(options.pagingLeft!="") {
        $(options.pagingLeft).html("<a class='paging-left left' rel='left' href='#'></a>");
      }
      else {
        $(options.pagingTag).prepend("<a class='paging-left left' rel='left' href='#'></a>");
      }
      
      if(options.pagingRight!="") {
        $(options.pagingRight).html("<a class='paging-right left' rel='right' href='#'></a>");
      }
      else {
